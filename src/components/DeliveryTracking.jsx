    ...
    <div className="w-full px-6 py-8 backdrop-blur-2xl bg-gradient-to-br from-gray-900/80 via-gray-800/80 to-black/80 rounded-[2rem] border border-gray-700 shadow-[0_0_50px_rgba(255,77,45,0.4)] overflow-hidden relative">
      ...
      >
        <div className="h-[500px] w-full relative">
          ...
          >
            ...
            <Marker position={[deliveryLat, deliveryLon]} icon={deliveryboyicon}>
              <Popup>
                <div className="font-bold text-center text-orange-600">Delivery Boy</div>
              </Popup>
            </Marker>

            <Marker position={[customerLat, customerLon]} icon={customericon}>
              <Popup>
                <div className="font-bold text-center text-green-700">Customer</div>
              </Popup>
            </Marker>

            {path.length > 0 && <Polyline positions={path} color="orange" weight={6} opacity={0.8} />}
          </MapContainer>
        ...
        <div className="mt-5">
          ...
          {showotp && (
            <div className="mt-4">
              <button className="w-full bg-green-600 p-4 font-bold text-white" onClick={sendOtp}>
                Send OTP
              </button>

              <p className="font-bold text-md text-center">
                Enter the OTP from <span className="text-[#ff4d2d] font-bold">{data3}</span>
              </p>
              <input
                type="text"
